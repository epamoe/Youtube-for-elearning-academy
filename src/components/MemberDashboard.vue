                ...
                >
                  <div class="w-1/4 ml-48">
                    ...
                    <button class="text-sm rounded-lg bg-amber-500 w-fit p-1 mb-5">
                      <a href="http://">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi inline-block mr-1 bi-pin-map-fill" viewBox="0 0 16 16">
                  ...
                  <div class="flex gap-x-1 absolute bottom-4 left-12">
                      <span class="inline-block mr-2">8.6</span>
                      <div v-for="i in [1,2,3,4,5]" :key="i" class="inline-block">
